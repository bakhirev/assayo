...
§ plugin.team_total.additionalMoney.title: Оценка возможных доп. затрат
§ plugin.team_total.forecastingMoneyAll.description: Возможная сумма выплат на зарплату за всё время всем возможным сотрудникам отдела, в том числе которые не фигурируют в логах, но могли быть (на основании нумерации задач в таск-трекере).    
§ plugin.team_total.moneyDevice.title: расходы на оборудование
§ plugin.team_total.moneyDevice.description: Возможная сумма затраченная на подготовку рабочих мест (покупка техники, мебели, оплата услуг связи и т.п.) за всё время всем возможным сотрудникам отдела, в том числе которые не фигурируют в логах, но могли быть.    
§ plugin.team_total.moneyLicence.title: расходы на лицензии (в том числе ИИ-подписки)
§ plugin.team_total.moneyLicence.description: Возможная сумма затраченная на покупку лицензий и подписок необходимых для выполенения рабочих задач за всё время всем возможным сотрудникам отдела, в том числе которые не фигурируют в логах, но могли быть.    
