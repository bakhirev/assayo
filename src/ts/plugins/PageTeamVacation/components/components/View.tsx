  ...
  return (
    ...
    >
      <Column
        ...
        title="plugin.team_vacation.details.author"
        minWidth={200}
        properties="author"
      />
      <Column
      ...
      <Column
        template={ColumnTypes.STRING}
        title="plugin.team_vacation.details.from"
        minWidth={130}
        formatter={(row: any) => getDate(row.from.milliseconds)}
      />
      <Column
        template={ColumnTypes.STRING}
        title="plugin.team_vacation.details.to"
        minWidth={130}
      ...
      <Column
        isSortable
        title="plugin.team_vacation.details.duration"
        properties="duration"
        minWidth={200}
